...
class ManoRenderer:
    def __init__(self, image_size=(512, 512), focal_length=6000, mano_vertices=None, mano_faces=None):
        self.image_size = image_size
        self.focal_length = focal_length  # Reduce focal length to obtain a wider field of view
    ...
    def render(self, vertex_colors = None, colormap_fn = lambda x: (np.array(x)),
               camera_t: np.ndarray = np.array([0, 0, 2.3]), smooth=True) -> np.ndarray:
        """
